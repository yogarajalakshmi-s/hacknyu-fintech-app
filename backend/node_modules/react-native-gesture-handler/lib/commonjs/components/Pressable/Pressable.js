...
function Pressable(props) {
  ...
  const pressableRef = (0, _react.useRef)(null);
  ...
  .cancelsTouchesInView(false).onBegin(event => {
    ...
    onHoverIn === null || onHoverIn === void 0 || onHoverIn((0, _utils.gestureToPressableEvent)(event));
  }).onFinalize(event => {
    ...
    onHoverOut === null || onHoverOut === void 0 || onHoverOut((0, _utils.gestureToPressableEvent)(event));
  ...
  const activateLongPress = (0, _react.useCallback)(event => {
    ...
    if (hasPassedBoundsChecks.current) {
      onLongPress === null || onLongPress === void 0 || onLongPress((0, _utils.gestureTouchToPressableEvent)(event));
